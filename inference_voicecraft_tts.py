...
from edit_utils import parse_tts
...
stop_repetition = 3 # -1 means do not adjust prob of silence tokens. if there are long silence or unnaturally strecthed words, increase sample_batch_size to 2, 3 or even 4
...
def main(orig_audio, orig_transcript, target_transcript, target_transcript_, temp_folder, savename, savetag=1):
    ...
    def resolve_overlap(starting_intervals, ending_intervals, audio_dur, codec_sr, sub_amount):
        while True:
    ...
    mask_interval = resolve_overlap(starting_intervals, ending_intervals, audio_dur, codec_sr, sub_amount)
    ...
    # save segments for comparison
    output_dir = "/apdcephfs_cq10_1603164/share_1603164/user/helinhwang/VoiceCraft/demo/generated_tts"
...
# orig_audio = "/apdcephfs_cq10_1603164/share_1603164/user/helinhwang/VoiceCraft/demo/test_noisy.wav"
# orig_transcript =    "在经常挨饿的这样的一个情况下他收到相应的这个胁迫我们整个的这个鸡那这个表达"
# target_transcript =  "在经常挨饿的这样的一个情况下他收到相应的这个胁迫能够更有效率地结合给用户提升更多的这种体验"
# target_transcript_ = "在经常挨饿的这样的一个情况下，他收到相应的这个胁迫，能够更有效率地结合，给用户提升更多的这种体验"
# temp_folder = "/apdcephfs_cq10_1603164/share_1603164/user/helinhwang/VoiceCraft/demo/temp_test"
# main(orig_audio, orig_transcript, target_transcript, target_transcript_, temp_folder, savename='test_noisy',savetag=1)
