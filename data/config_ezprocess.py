...
def MyParser():
    ...
    parser.add_argument("--encodec_aug_folder_name", type=str, default="encodec_16khz_4codebooks_prosody_speakingrate_augmented", help="folder where encodec codes of augmented data are stored")
    parser.add_argument("--prosody_timbre_folder_name", type=str, default="codes_facodec", help="folder where codes of prosody and timbre are stored")
    parser.add_argument("--manifest_name", type=str, default="manifest_aug", help="metadata filename")
    ...
    parser.add_argument("--prosody_max_length", type=float, default=3, help="in second")
    ...
    parser.add_argument("--train_gap", type=int, default=5, help="to keep consistency, leave several tokens not to be predicted at the start and end of the masking span")
    ...
    parser.add_argument('--prosody_vocab_size', type=int, default=1024, help="Size of prosody vocabulary")
    ...
    parser.add_argument('--prosody_pad_token', type=int, default=1024, help='padding of the prosody codes, not attended')
    parser.add_argument('--mts', type=int, default=2053, help='mask token start')

    # model focused
    parser.add_argument('--spk_emb', type=int, default=256, help='speaker embedding dimension')
    ...
    parser.add_argument('--prosody_embedding_dropout', type=float, default=0.1, help='Dropout for prosody embedding')
    ...
    parser.add_argument('--prosody_positional_embedding_dropout', type=float, default=0.1, help='Dropout for prosody positional embedding')
