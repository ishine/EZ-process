...
import logging
from data import gigaspeech_voicecraft
...
class Trainer:
    ...
    def _setup_dataloader(self):
        train_dataset, val_dataset = gigaspeech_voicecraft.dataset(self.args, 'train'), gigaspeech_voicecraft.dataset(self.args, 'validation')
