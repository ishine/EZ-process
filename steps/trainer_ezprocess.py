...
import logging
from data import gigaspeech_ezprocess
from models import ezprocess
...
class Trainer:
    ...
    def _setup_dataloader(self):
        train_dataset, val_dataset = gigaspeech_ezprocess.dataset(self.args, 'train'), gigaspeech_ezprocess.dataset(self.args, 'validation')
    ...
    def _setup_models(self):
        model = ezprocess.EZProcess(self.args)
